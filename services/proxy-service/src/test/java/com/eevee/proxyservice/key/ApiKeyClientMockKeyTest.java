...
class ApiKeyClientMockKeyTest {
    ...
    void openaiUsesMockKeyOpenaiWhenSet() {
        ...
        ApiKeyClient.ResolvedApiKey resolved = client.resolveApiKey("user-1", null, AiProvider.OPENAI, null, null).block();
    ...
    void googleUsesMockKeyGoogleWhenSet() {
        ...
        ApiKeyClient client = new ApiKeyClient(props);
        ApiKeyClient.ResolvedApiKey resolved = client.resolveApiKey("user-1", null, AiProvider.GOOGLE, null, null).block();
        assertThat(resolved).isNotNull();
    ...
    void fallsBackToLegacyMockKeyWhenProviderSpecificBlank() {
        ...
        ApiKeyClient client = new ApiKeyClient(props);
        ApiKeyClient.ResolvedApiKey openai = client.resolveApiKey("user-1", null, AiProvider.OPENAI, null, null).block();
        ApiKeyClient.ResolvedApiKey google = client.resolveApiKey("user-1", null, AiProvider.GOOGLE, null, null).block();
