package com.eevee.billingservice.security;
...
public class BillingGatewayTrustFilter extends OncePerRequestFilter {

    public static final String ATTR_USER_ID = "billing.authenticatedUserId";
    ...
    public BillingGatewayTrustFilter(BillingProperties properties) {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return path == null || !path.startsWith("/api/v1/expenditure");
    }
