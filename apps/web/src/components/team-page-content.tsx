...
/**
 * 팀 콘솔(Task37-32): 좌측 팀 UI는 HostShell secondarySidebar 슬롯에서 렌더링,
 * 이 컴포넌트는 우측 usage MF 영역만 담당한다.
 */
export function TeamPageContent() {
  ...
  return (
    <div className="host-remote-slot flex min-h-0 min-w-0 w-full flex-1 flex-col gap-4">
