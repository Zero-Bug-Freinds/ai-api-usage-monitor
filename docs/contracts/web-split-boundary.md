...
버전: 1.8  
관련: [저장소 구조](../repository-structure.md) §6, [architecture.md](../architecture.md) §10.2·§13.3, [`docker/web-edge/nginx.conf`](../../docker/web-edge/nginx.conf), [web-identity-bff.md](./web-identity-bff.md), [web-gateway-bff.md](./web-gateway-bff.md), [web-team-bff.md](./web-team-bff.md), [mfe-pages-only-remote-split-guidance-20260414.md](../mfe-pages-only-remote-split-guidance-20260414.md)
